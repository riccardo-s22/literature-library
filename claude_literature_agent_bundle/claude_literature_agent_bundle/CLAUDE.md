...
- marine ecotoxicology, environmental monitoring, multi-stressor experiments, shellfish and fish physiology, contaminant exposure, and ecological risk assessment.
...
4. create or update a paper record using `PAPER_RECORD_TEMPLATE.md`;
...
Use `DATASET_RECORD_TEMPLATE.md`. For every candidate dataset, verify:
...
Use `SYNTHESIS_NOTE_TEMPLATE.md` when a question depends on multiple papers. A synthesis must preserve:
- inclusion scope;
- evidence table;
- convergent findings;
...
- `PAPER_RECORD_TEMPLATE.md` — canonical paper extraction format.
- `DATASET_RECORD_TEMPLATE.md` — public dataset evaluation format.
- `PROJECT_CONTEXT_TEMPLATE.md` — project-specific facts and constraints.
- `SYNTHESIS_NOTE_TEMPLATE.md` — cross-paper evidence synthesis.
